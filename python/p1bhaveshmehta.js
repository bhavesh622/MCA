...
obj2 = createObject({property:['name','rollno']},{values:['a',123]},{attributename:{writable: 'true'}, attributerollno:{configurable: 'true'}});
...
console.log(typeof studentMap2); // WeakMap (cause object is the key instead of string)
