...
class General(commands.Cog, name="general-normal"):
    ...
    async def botinfo(self, context: Context) -> None:
        ...
        """
        embed = disnake.Embed(
            description="Ace of Management, but really the jack of all trades.",
            color=0x9C84EF
        )
        embed.set_author(
    ...
    async def server(self, context: Context) -> None:
        ...
        """
        embed = disnake.Embed(
            description=f"Join the support server for the bot by clicking [here](https://discord.gg/XUEQFFmhQT).",
            color=0xD75BF4
        )
        try:
            await context.author.send(embed=embed)
